...
In dieser Arbeit wird nun für diese Anomalieerkennung eine Implementation des \textit{Robust Random Cut Forest} Verfahrens \cite{guha2016rrcfTheory} benutzt. Als Vergleichsverfahren wird das dem Random Forest zugrundeliegende \textit{Isolation Forest} \cite{liu2012isolation} Verfahren angewandt. Die Wahl zweier unüberwachter Lernverfahren war dabei extern durch die Aufgabenstellung vorgegeben und begründet sich durch den zu hohen Aufwand den ein manuelles Labeling des Testdatensatzes, aufgrund seiner Größe, sowie der relativen Knappheit an Vertretern der verschiedenen Anomalieklassen in diesem mit sich bringen würde. 
