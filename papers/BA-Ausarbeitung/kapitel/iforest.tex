...
\label{alg:ITpath}
\begin{algorithmic}[1]
\REQUIRE $x$ - ein Punkt, $T$ - ein iTree, $hlim$ - eine Tiefenbegrenzung, $e$ -  momentane Weglänge; 0 zur Initialisierung
