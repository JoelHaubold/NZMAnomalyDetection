...
Zum Testen inwiefern sich diese Auswertung automatisieren lässt, sollen zuerst vordefinierte Anomalien automatisch auf dem Datensatz erkannt werden. Dazu wurde eine Teilmenge dieser Daten, in Form von der gemessenen absoluten Spannung von 17 Messstationen als Grundlage dieser Arbeit freigegeben.



\section{Aufbau der Arbeit}
In dieser Arbeit wird nun für diese Anomalieerkennung eine Implementation des \textit{Robust Random Cut Forest} Verfahrens \cite{guha2016rrcfTheory} benutzt. Als Vergleichsverfahren wird das dem Random Forest zugrundeliegende \textit{Isolation Forest} \cite{liu2012isolation} Verfahren angewandt.
